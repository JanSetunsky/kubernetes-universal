...
$PROJECT_PROCEDURES_SC = {
    $InvokeProcedure = Invoke-Project_Procedures -OperatingSystem $OS_TYPE -BuildData $BuildData -Procedures ('LOCALHOST_MINIKUBE_INSTALL_JENKINS_PLUGINS') -MeasureDuration $True -ErrorAction Stop
}
