...
$PROJECT_PROCEDURES_SC = {
    $InvokeProcedure = Invoke-Project_Procedures -OperatingSystem $OS_TYPE -BuildData $BuildData -Procedures ('MINIKUBE_DEPLOY_IMAGE') -MeasureDuration $True -ErrorAction Stop
}
