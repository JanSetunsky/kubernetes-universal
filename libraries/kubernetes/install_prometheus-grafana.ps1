...
$PROJECT_PROCEDURES_SC = {
    $InvokeProcedure = Invoke-Project_Procedures -OperatingSystem $OS_TYPE -BuildData $BuildData -Procedures ('LOCALHOST_MINIKUBE_OBSERVABILITY_STACK_Helm_Install_Prometheus_Grafana') -MeasureDuration $True -ErrorAction Stop
}
